...
from app.schemas.allocation import AssignAssetSchema, ReturnAssetsSchema
...
def assign_asset_to_employee(
    ...
    return assign_asset(request, current_user, db)
...
def return_assigned_asset(
    ...
    return return_asset(request, db)
...
def view_asset_history(
    ...
    return get_asset_history(asset_id, db)
